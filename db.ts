...
export async function addTodos(db: SQLiteDatabase, text: string): Promise<void> {
...
export async function updateTodoStatus(db: SQLiteDatabase, id: string, status: string): Promise<void> {
